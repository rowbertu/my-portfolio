...
import moodGardenImg1 from "./assets/moodGarden2.png";
import moodGardenImg2 from "./assets/moodGarden.png";
...
export default function PortfolioApp() {
  const projects = [
    {
      title: "GaSolve: IoT-Enabled LPG Leak Detection System",
    ...
    },
    {
      ...
      demoUrl: "https://drive.google.com/file/d/1rAT7sTlwDGwPrSRXjB2UzJJZ0LthjQ0s/view?usp=sharing",
    },
    {
    ...
    return (
      ...
      >
        ...
        <div className="relative aspect-square w-full shrink-0 overflow-hidden bg-gray-100">
          ...
          <div 
            className={`absolute inset-0 bg-yellow-100/30 transition-opacity duration-300 z-10 ${
              isHovering ? "opacity-100" : "opacity-0"
            }`} 
          />

          {/* Centered Buttons - Appear on Hover side-by-side */}
          <div
            className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-30 flex items-center gap-3 w-full justify-center px-4 transition-all duration-300 ${
              isHovering
          ...
          >
            ...
            <a
              ...
              className="flex items-center gap-2 rounded-full bg-[#24292e]/95 px-4 py-3 text-xs md:text-sm font-semibold text-white backdrop-blur-md transition-all duration-300 hover:bg-black hover:scale-105 shadow-xl"
            >
            ...
            {project.demoUrl && (
              <a
                ...
                rel="noopener noreferrer"
                onClick={(e) => e.stopPropagation()}
                className="flex items-center gap-2 rounded-full bg-amber-600/95 px-4 py-3 text-xs md:text-sm font-semibold text-white backdrop-blur-md transition-all duration-300 hover:bg-amber-700 hover:scale-105 shadow-xl"
              >
